...
public:
  ...
  auto render() noexcept {
    optixLaunchParamsBuffer_.set(LaunchParams{reinterpret_cast<float3 *>(imageBuffer_.getData()), *reinterpret_cast<float3 *>(&lightPosition_), camera_, optixState_.getTraversableHandle()});
